class GuitaristController < ApplicationController
	...
	post '/new' do
		...
		new_guitarist.guitarist_name = params[:guitarist_name]

		logged_in_user = User.find_by({:username => session[:username]})
		new_guitarist.user_id = logged_in_user.user_id
		new_guitarist.save
	...
	put '/:id' do
		...
		guitarist_update.guitarist_name = params[:guitarist_name]
